...
Luego de calcular la matriz de viajes, con un $\alpha$ igual a 0.00022 y un k igual a 1 se obtuvo la siguiente matriz:
...
Para poder mejorar la presición de la matriz obtenida (Tabla \ref{table:results_zones}), se implementó el método Furness, a continuación se muestra la matriz obtenida:
\begin{table}[h!]
    \centering
    \resizebox{\textwidth}{!}{%
