...
\begin{table}[H]
  ...
  \noindent La Tabla \ref{table:global} presenta la distribución inicial de viajes entre zonas utilizando el modelo gravitacional. Esta distribución ofrece una primera aproximación de los flujos de viajes, pero aún requiere ajustes adicionales para que refleje con precisión los totales proyectados para el año 2024.
